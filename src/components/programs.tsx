      ...
      <section id="programs" className="py-20 bg-[#033201] fade-scale">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center space-x-8">
            {/* Text Section */}
            <div className="w-1/2">
              <h2 className="text-[48px] font-bold text-[#0BF78F] mb-4">Programs/Initiatives</h2>
              <p className="text-[20px] text-white">
              Our initiatives at ROD Africa Initiative are designed to <br />create lasting change and open doors of opportunity for <br/> young Africans. Here’s how we’re making a difference:
              </p>
            </div>
